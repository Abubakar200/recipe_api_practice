...
const NotFound = () => {
    ...
    <div className="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
        ...
        <Link href="/" className="flex items-center space-x-2 bg-black hover:bg-white hover:text-black text-gray-100 px-4 py-2 mt-6 rounded transition duration-150" title="Return Home">
